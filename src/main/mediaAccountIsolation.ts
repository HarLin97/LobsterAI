...
export interface AuthRefreshSnapshot extends MediaAccountScope {
  refreshToken: string;
}
...
export const canCommitAuthRefresh = (
  expected: AuthRefreshSnapshot,
  currentScope: MediaAccountScope | null,
  currentRefreshToken: string | null,
): boolean => (
  isMediaAccountScopeCurrent(expected, currentScope)
