...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    close: '关闭',
    activityDefaultTitle: '活动',
    activityLoading: '正在加载活动…',
    activityLoadFailed: '活动页面暂时无法加载',
    activityViewNow: '立即参与',
  ...
  en: {
    ...
    close: 'Close',
    activityDefaultTitle: 'Activity',
    activityLoading: 'Loading activity…',
    activityLoadFailed: 'The activity page could not be loaded',
    activityViewNow: 'View activity',
