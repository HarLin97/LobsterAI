...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    nodeDeploymentUploadingPackage: '正在上传服务包。',
  ...
  en: {
    ...
    nodeDeploymentShare: 'Deploy share',
    ...
    nodeDeploymentUploadingPackage: 'Uploading the service package.',
    ...
    nodeDeploymentAnalyzeAction: 'Check',
    ...
    nodeDeploymentPackageSummary: 'Package preview',
