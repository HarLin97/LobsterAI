...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    enterpriseAccountRoleMember: '普通成员',
    enterpriseAccountManagement: '企业管理后台',
    enterpriseAccountAdjustQuota: '调整额度',
    enterpriseQuotaMemberTitle: '你的额度已用完',
    enterpriseQuotaMemberAdminTitle: '当前成员额度已用完',
    enterpriseQuotaMemberMemberDesc: '请联系企业管理员调整额度。',
    enterpriseQuotaMemberAdminDesc: '可进入用量与额度页面调整成员月度额度。',
    enterpriseQuotaPoolTitle: '企业额度已用完',
    enterpriseQuotaPoolMemberDesc: '请联系企业管理员。',
    enterpriseQuotaPoolAdminDesc: '可进入企业管理后台购买企业订阅包或调整额度。',
    ...
    enterpriseQuotaGoAdmin: '进入企业管理后台',
    enterpriseQuotaRechargeOrAdjust: '购买企业订阅包 / 调整额度',
    enterpriseQuotaDismiss: '关闭提示',
    planFree: '免费',
    planStandard: '标准',
    planAdvanced: '进阶',
    planPro: '专业',
  ...
  en: {
    ...
    enterpriseAccountRoleMember: 'Member',
    ...
    enterpriseQuotaMemberAdminTitle: 'This member quota has been used up',
    enterpriseQuotaMemberMemberDesc: 'Contact your enterprise administrator to adjust your quota.',
    enterpriseQuotaMemberAdminDesc: 'Open Usage & Quotas to adjust the monthly member quota.',
    enterpriseQuotaPoolTitle: 'Enterprise credits have been used up',
    enterpriseQuotaPoolMemberDesc: 'Contact your enterprise administrator.',
    enterpriseQuotaPoolAdminDesc: 'Open Enterprise Admin to purchase credits or adjust quotas.',
    ...
    enterpriseQuotaGoAdmin: 'Open Enterprise Admin',
    enterpriseQuotaRechargeOrAdjust: 'Purchase credits / Adjust quota',
    enterpriseQuotaDismiss: 'Dismiss',
    planFree: 'Free',
