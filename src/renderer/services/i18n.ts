...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authZeroCredits: '0积分',
    enterpriseAccountBelongsTo: '所属企业：{name}',
    enterpriseAccountRoleSuperAdmin: '超级管理员',
    enterpriseAccountRoleMember: '企业身份',
    enterpriseAccountManagement: '企业管理后台',
    enterpriseAccountQuota: '我的额度',
    enterpriseAccountChooseEnterprise: '选择企业',
    enterpriseAccountEnter: '进入',
    enterpriseAccountAdjustQuota: '调整额度',
    enterpriseQuotaMemberTitle: '你的额度已用完',
    enterpriseQuotaMemberMemberDesc: '向企业管理员申请提高成员额度后继续使用 LobsterAI。',
    enterpriseQuotaMemberAdminDesc: '调整额度后继续使用 LobsterAI。',
    enterpriseQuotaMemberInterrupt: '你已达到使用上限，请联系企业管理员。',
    enterpriseQuotaMemberAdminInterrupt: '你已达到个人额度上限，可调整额度。',
    enterpriseQuotaPoolTitle: '企业积分已用完',
    enterpriseQuotaPoolMemberDesc: '通知企业管理员购买企业积分包后继续使用 LobsterAI。',
    enterpriseQuotaPoolAdminDesc: '购买企业积分包后，企业成员可继续使用 LobsterAI。',
    enterpriseQuotaPoolInterrupt: '企业积分已达到使用上限，请补充积分后继续。',
    enterpriseQuotaExpiredTitle: '企业积分已过期',
    enterpriseQuotaExpiredMemberDesc: '企业积分批次已全部过期，请联系企业管理员。',
    enterpriseQuotaExpiredAdminDesc: '企业积分批次已全部过期，请购买企业订阅包后继续使用。',
    enterpriseQuotaPurchaseCredits: '购买企业积分包',
    enterpriseQuotaRequestIncrease: '申请提高额度',
    enterpriseQuotaNotifyAdmin: '通知管理员购买',
    enterpriseQuotaRequestSubmitting: '提交中…',
    enterpriseQuotaRequestSubmitted: '申请已提交，企业管理员会在管理后台收到通知。',
    enterpriseQuotaRequestAlreadyPending: '申请已提交，请等待企业管理员处理。',
    ...
    coworkErrorEnterpriseMembershipRevoked: '你已被移出当前企业，已退出登录。请重新登录并选择可用身份。',
  ...
  en: {
    ...
    enterpriseAccountBelongsTo: 'Organization: {name}',
    enterpriseAccountRoleSuperAdmin: 'Super administrator',
    enterpriseAccountRoleMember: 'Enterprise identity',
    enterpriseAccountManagement: 'Enterprise admin',
    enterpriseAccountQuota: 'My quota',
    enterpriseAccountChooseEnterprise: 'Choose an enterprise',
    ...
    enterpriseQuotaMemberMemberDesc: 'Request a higher member quota from your enterprise administrator to continue using LobsterAI.',
    enterpriseQuotaMemberAdminDesc: 'Adjust your quota to continue using LobsterAI.',
    enterpriseQuotaMemberInterrupt: 'You have reached your usage limit. Contact your enterprise administrator.',
    enterpriseQuotaMemberAdminInterrupt: 'You have reached your personal quota. You can adjust it.',
    enterpriseQuotaPoolTitle: 'Enterprise credits have been used up',
    enterpriseQuotaPoolMemberDesc: 'Notify your enterprise administrator to purchase credits and continue using LobsterAI.',
    enterpriseQuotaPoolAdminDesc: 'Purchase enterprise credits so members can continue using LobsterAI.',
    enterpriseQuotaPoolInterrupt: 'Enterprise credits have reached the limit. Add credits to continue.',
    enterpriseQuotaExpiredTitle: 'Enterprise credits have expired',
    enterpriseQuotaExpiredMemberDesc: 'All enterprise credit batches have expired. Contact your enterprise administrator.',
    enterpriseQuotaExpiredAdminDesc: 'All enterprise credit batches have expired. Purchase an enterprise pack to continue.',
    enterpriseQuotaPurchaseCredits: 'Purchase enterprise credits',
    ...
    enterpriseQuotaRequestSubmitted: 'Request submitted. Your enterprise administrator will be notified.',
    ...
    coworkErrorEnterpriseMembershipRevoked:
      'You have been removed from the current enterprise and signed out. Sign in again to choose an available identity.',
