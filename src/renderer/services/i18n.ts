...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    nodeDeploymentPersistenceSummary: '云端保存数据',
    nodeDeploymentPersistenceSummaryValue: '{count} 项：{paths}',
    nodeDeploymentPersistenceTitle: '服务数据',
    nodeDeploymentPersistenceEnable: '保护数据',
    nodeDeploymentPersistenceEnabledHint: '更新服务后，排行榜、问卷结果或上传内容会继续保留。',
    nodeDeploymentPersistenceDisabledHint: '未检测到需要保存的数据。需要保留排行榜、问卷结果或上传内容时，可以手动添加文件夹。',
    nodeDeploymentPersistenceShowItems: '查看保存内容',
    nodeDeploymentPersistenceHideItems: '收起保存内容',
    nodeDeploymentPersistenceAddDirectory: '添加文件夹',
    nodeDeploymentPersistenceNoItems: '还没有选择要保存的内容。',
    nodeDeploymentPersistenceRemove: '移除',
    nodeDeploymentPersistenceDataFileHint: '检测到本地数据文件。如果这次修改了数据保存方式，建议先下载线上数据备份。',
    nodeDeploymentPersistenceUsage: '已使用 {used} / {quota}',
    nodeDeploymentPersistenceEstimated: '估算',
    nodeDeploymentPersistenceDownload: '下载备份',
    nodeDeploymentPersistenceImport: '用备份替换',
    nodeDeploymentPersistenceClear: '清空数据',
    nodeDeploymentPersistenceDownloadComplete: '线上数据备份已保存到 {path}',
    nodeDeploymentPersistenceDownloadFailed: '线上数据备份下载失败。',
    nodeDeploymentPersistenceClearPrompt: '这会清空当前线上服务数据。请输入“清空线上数据”继续。',
    nodeDeploymentPersistenceClearConfirmText: '清空线上数据',
    nodeDeploymentPersistenceClearComplete: '线上服务数据已清空。',
    nodeDeploymentPersistenceClearFailed: '清空线上服务数据失败。',
    nodeDeploymentPersistenceImportSelectTitle: '选择服务数据备份',
    nodeDeploymentPersistenceImportPrompt: '这会用所选备份替换当前线上服务数据。请输入“替换线上数据”继续。',
    nodeDeploymentPersistenceImportConfirmText: '替换线上数据',
    nodeDeploymentPersistenceImportComplete: '线上服务数据已替换。',
    nodeDeploymentPersistenceImportFailed: '替换线上服务数据失败。',
  ...
  en: {
    ...
    nodeDeploymentPersistenceSummary: 'Cloud saved data',
    nodeDeploymentPersistenceSummaryValue: '{count} item(s): {paths}',
    nodeDeploymentPersistenceTitle: 'Service data',
    nodeDeploymentPersistenceEnable: 'Protect data',
    nodeDeploymentPersistenceEnabledHint: 'Leaderboards, survey results, uploads, and other service data will be kept when the service is updated.',
    nodeDeploymentPersistenceDisabledHint: 'No saved data was detected. Add a folder if this service needs to keep leaderboards, survey results, or uploads.',
    nodeDeploymentPersistenceShowItems: 'View saved items',
    nodeDeploymentPersistenceHideItems: 'Hide saved items',
    nodeDeploymentPersistenceAddDirectory: 'Add folder',
    nodeDeploymentPersistenceNoItems: 'No saved items selected yet.',
    nodeDeploymentPersistenceRemove: 'Remove',
    nodeDeploymentPersistenceDataFileHint: 'A local data file was detected. Download an online data backup before deploying if the data storage format changed.',
    nodeDeploymentPersistenceUsage: '{used} / {quota} used',
    nodeDeploymentPersistenceEstimated: 'Estimated',
    nodeDeploymentPersistenceDownload: 'Download backup',
    nodeDeploymentPersistenceImport: 'Replace with backup',
    nodeDeploymentPersistenceClear: 'Clear data',
    nodeDeploymentPersistenceDownloadComplete: 'Online data backup saved to {path}',
    nodeDeploymentPersistenceDownloadFailed: 'Failed to download the online data backup.',
    nodeDeploymentPersistenceClearPrompt: 'This will clear the current online service data. Type "清空线上数据" to continue.',
    nodeDeploymentPersistenceClearConfirmText: '清空线上数据',
    nodeDeploymentPersistenceClearComplete: 'Online service data was cleared.',
    nodeDeploymentPersistenceClearFailed: 'Failed to clear online service data.',
    nodeDeploymentPersistenceImportSelectTitle: 'Choose service data backup',
    nodeDeploymentPersistenceImportPrompt: 'This will replace current online service data with the selected backup. Type "替换线上数据" to continue.',
    nodeDeploymentPersistenceImportConfirmText: '替换线上数据',
    nodeDeploymentPersistenceImportComplete: 'Online service data was replaced.',
    nodeDeploymentPersistenceImportFailed: 'Failed to replace online service data.',
